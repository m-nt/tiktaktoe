...
public class NetManager : NetworkManager
{
    ...
    public override void Awake()
    {
        ...
        // if (is_server)StartServer();
        base.Awake();
    }
    public void OnNewMatch(){
        Debug.LogError(numPlayers);
        StartClient();
        // if (numPlayers < 2)StartClient();
    }
    ...
    public override void OnServerConnect(NetworkConnectionToClient conn) {
        Debug.LogError("on server connecnt");
    }
    ...
    {
        Debug.LogError("Im connected");
        // Game.self.Add_Player();
    ...
    public override void OnStartClient() {
        ...
        if (numPlayers < 2) NetworkClient.AddPlayer();
        // NetworkClient.Connect(networkAddress);
        // NetworkClient.Ready();
